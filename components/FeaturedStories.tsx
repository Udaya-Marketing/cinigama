...
export default function FeaturedStories() {
  ...
  return (
    <section className="bg-ivory py-24 sm:py-32 lg:py-40">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 sm:mb-20 pb-8 border-b border-bordergray">
          <div>
            <div className="inline-flex items-center space-x-2 text-bronze text-[11px] sm:text-xs font-sans tracking-[0.25em] uppercase mb-3 font-semibold">
        ...
        <div className="space-y-12 sm:space-y-16">
          {/* Row 1: Story 1 (Full-width Landscape with Overlaid / Side Typography) */}
          {story1 && (
            <Link
              href={`/stories/${story1.slug}`}
              className="group block relative overflow-hidden bg-beige"
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 items-center">
                ...
                <div className="lg:col-span-4 p-8 sm:p-12 lg:p-10 flex flex-col justify-between h-full bg-beige/40">
                  <div>
                    <span className="text-[10px] uppercase tracking-[0.25em] text-bronze font-medium block mb-3">
                      {story1.category} • {story1.location}
                    </span>
                    <h3 className="font-serif text-3xl sm:text-4xl text-charcoal mb-4 font-light leading-snug group-hover:text-bronze transition-colors">
                      {story1.couple}
                    </h3>
                  ...
                  <div className="inline-flex items-center space-x-2 text-xs uppercase tracking-[0.2em] text-charcoal font-medium">
          ...
          {/* Row 2: Two Stacked / Side-by-Side Portraits (Stories 2 & 3) */}
            ...
            {story2 && (
              ...
              >
                <div className="relative aspect-[4/5] w-full overflow-hidden">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-10 z-20 text-ivory">
                    <span className="text-[10px] uppercase tracking-[0.25em] text-ivory/80 block mb-2">
                      {story2.category} • {story2.location}
                    </span>
                    <h3 className="font-serif text-2xl sm:text-3xl text-ivory font-light mb-2">
                      {story2.couple}
                    </h3>
                    <div className="inline-flex items-center space-x-2 text-xs uppercase tracking-[0.2em] text-ivory/90 group-hover:text-bronze-light transition-colors">
          ...
          {/* Row 3: Story 4 (Landscape Feature) */}
          {story4 && (
            <Link
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-0 items-center">
                <div className="lg:col-span-4 p-8 sm:p-12 lg:p-10 flex flex-col justify-between h-full bg-beige/40 order-2 lg:order-1">
                  <div>
                    <span className="text-[10px] uppercase tracking-[0.25em] text-bronze font-medium block mb-3">
